...
"""
Here it is for an election with 100000 ballots, where Yes is the winner, with a margin of 2%, and 10% are Invalid
(undervote/overvote/residual).
    
Reported \ Actual  Invalid No     Yes
 Invalid           9890    100    10
      No           0       44000  0
     Yes           500     5      45495
...
{('STRAT', 'CCVR', '0'): 3784,
 ('STRAT', 'CCVR', '1'): 3956,
 ('STRAT', 'CNONCVR', 'noCVR'): 0,
 ('STRAT', 'CNONCVR', '1'): 644,
 ('STRAT', 'CNONCVR', '0'): 616,
 ('STRAT', 'CCVR', 'noCVR'): 0,
 ('STRAT', 'CCVR', 'Invalid'): 0,
 ('STRAT', 'CNONCVR', 'Invalid'): 0}
"""
